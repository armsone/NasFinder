...
private final class WebHardHTTPConnection: @unchecked Sendable {
    ...
    @media(prefers-color-scheme:dark){body{background:#111115;color:#f5f5f7}.files,.row,.transfer,.files.small .row,.files.poster .row,dialog{background:#1c1c20}.row,#uploadQueue li{border-color:#303036}.button.secondary,button.secondary{background:#303038;color:#eee}.meta,#path,#status,#uploadHint,.upload-panel p{color:#aaa}.preview{background:#29292f}}
